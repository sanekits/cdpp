...
```
curl -L https://github.com/sanekits/cdpp/releases/download/2.0.0/cdpp-setup-2.0.0.sh \
...
- Download the [latest version of `cdpp-setup-2.0.0.sh`](https://github.com/sanekits/cdpp/releases/latest)

- Run the self-extracting setup:
```console
user@laptop$ cd ~/Downloads && ./cdpp-setup-2.0.0.sh
```
