...
```
curl -L https://github.com/sanekits/cdpp/releases/download/0.9.9/cdpp-setup-0.9.9.sh \
...
- Download the [latest version of `cdpp-setup-0.9.9.sh`](https://github.com/sanekits/cdpp/releases/latest)

- Run the self-extracting setup:
```console
user@laptop$ cd ~/Downloads && ./cdpp-setup-0.9.9.sh
```
